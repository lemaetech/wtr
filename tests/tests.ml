...
let%expect_test _ =
  pp_match "/home/products/" ; [%expect {| "full splat page" |}]

let%expect_test _ =
  pp_match "/home/product1/" ; [%expect {| "Wildcard page. product1" |}]
...
let%expect_test _ =
  pp_match "/fruit/apple" ; [%expect {| "Apples are juicy!" |}]
...
let%expect_test _ =
  pp_match "/fruit/orange" ; [%expect {| "Orange is a citrus fruit." |}]

let%expect_test _ = pp_match "/fruit/guava" ; [%expect {| None |}]
let%expect_test _ = pp_match "/" ; [%expect {| "404 Not found" |}]
let%expect_test _ = pp_match "" ; [%expect {| None |}]
